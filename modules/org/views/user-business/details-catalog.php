                        ...
                        <tr>
                            <td colspan='2' style="text-align:right">
                                <a class="btn btn-primary"
                                    href="<?=Yii::getAlias('@web')?>/org/user-business/update-catalog?business_id=0&id=<?=$model->id?>">Update</a>
                            </td>
                        </tr>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <td colspan='2' style="text-align:right">
                        <a class="btn btn-primary"
                            href="<?=Yii::getAlias('@web')?>/org/user-business/update-catalog-details?businessId=<?=$model->id?>&id=<?=$model->id?>">Update</a>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <td colspan='2' style="text-align:right">
                            <a class="btn btn-primary"
                                href="<?=Yii::getAlias('@web')?>/org/user-business/catalog-link?catalogId=<?=$model->id?>&id=<?=$businessCatalogLinks->id?>">Update</a>
                            <a class="btn btn-danger"
                                href="<?=Yii::getAlias('@web')?>/org/user-business/catalog-link?catalogId=<?=$model->id?>&id=<?=$businessCatalogLinks->id?>">Delete</a>
                ...
                <div>
                    ...
                    <a class="btn btn-success"
                        href="<?=Yii::getAlias('@web')?>/org/user-business/catalog-link?catalogId=<?=$model->id?>">Add
                        New</a>
                </div>
