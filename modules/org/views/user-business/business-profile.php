                        ...
                        <tr>
                            <td colspan='2' style="text-align:right">
                                <a class="btn btn-primary"
                                    href="<?=Yii::getAlias('@web')?>/org/user-business/business-update?user_id=<?=$user_id?>&id=<?=$model->id?>">Update</a>
                            </td>
                        </tr>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <td colspan='2' style="text-align:right">
                        <a class="btn btn-primary"
                            href="<?=Yii::getAlias('@web')?>/org/user-business/business-update-details?user_id=<?=$user_id?>&id=<?=$model->id?>">Update</a>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <td colspan='2' style="text-align:right">
                            <a class="btn btn-primary"
                                href="<?=Yii::getAlias('@web')?>/org/user-business/update-working-day?user_id=<?=$user_id?>&business_id=<?=$model->id?>working_day_id=<?=$businessWorkingDay->id?>">Update</a>
