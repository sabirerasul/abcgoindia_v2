                                ...
                                <tr>
                                    ...
                                    <td style='text-align:right';>
                                            <a class="btn btn-primary"
                                                href="<?=Yii::getAlias('@web')?>/org/user/user-update?id=<?=$model->id?>"><i class="fas fa-edit"></i></a>
                                    </td>
                                </tr>
                            </thead>
                            <tbody>
        ...
        if($userAddress->status == 1){ ?>
                            <tbody>
                                ...
                                <tr>
                                    <td colspan='2'>
                                        <a class="btn btn-primary"
                                            href="<?=Yii::getAlias('@web')?>/org/user/save-user-address?userId=<?=$model->id?>&userAddressId=<?=$userAddress->id?>">
                                            <i class="fas fa-edit"></i>

                                        </a>
                                        <a class="btn btn-danger"
                                            href="<?=Yii::getAlias('@web')?>/org/user/delete-user-address?userId=<?=$model->id?>&userAddressId=<?=$userAddress->id?>">
                                ...
                                <tr>
                                    <td colspan='2'>
                                        <a class="btn btn-success"
                                            href="<?=Yii::getAlias('@web')?>/org/user/save-user-address?userId=<?=$model->id?>&userAddressId=0"><i
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary"
                                            href="<?=Yii::getAlias('@web')?>/org/user/save-user-hobby?userId=<?=$model->id?>&userHobbyId=<?=$userHobbies->id?>">
                                            <i class="fas fa-edit"></i></a>
                                        <a class="btn btn-danger"
                                            href="<?=Yii::getAlias('@web')?>/org/user/delete-user-hobby?userId=<?=$model->id?>&userHobbyId=<?=$userHobbies->id?>">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan='2'>
                                        <a class="btn btn-success"
                                            href="<?=Yii::getAlias('@web')?>/org/user/save-user-hobby?userId=<?=$model->id?>&userHobbyId=0"><i
                                                class="fas fa-plus"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary"
                                            href="<?=Yii::getAlias('@web')?>/org/user/save-user-profile-link?userId=<?=$model->id?>&userProfileLinkId=<?=$userProfileLinks->id?>">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a class="btn btn-danger"
                                            href="<?=Yii::getAlias('@web')?>/org/user/delete-user-profile-link?userId=<?=$model->id?>&userProfileLinkId=<?=$userProfileLinks->id?>">
                                            <i class="fas fa-trash"></i>
                                        </a>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <a class="btn btn-success"
                                            href="<?=Yii::getAlias('@web')?>/org/user/save-user-profile-link?userId=<?=$model->id?>&userProfileLinkId=0"><i
                                                class="fas fa-plus"></i></a>
                                    </td>
                                </tr>
                            </tbody>
