                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?=Yii::getAlias('@web');?>/user/profile?id=3">
                                ...
                                <a class="dropdown-item" href="<?=Yii::getAlias('@web')?>/site/logout" data-toggle="modal" data-target="#logoutModal">
